    ...
    return (
      <>
        <main className="contact">
          <h1 className="first">You can find me on:</h1>
          ...
          <h1>Take a look at my resume here:</h1>
          <section className="resume">
            <a href="https://drive.google.com/file/d/1m6QesikZMinxv3UVS472HrY5Bfs5_cRO/view?usp=sharing" target="_blank" rel="noreferrer"> 
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
